...
<head>
    ...
    <link rel="stylesheet" href="./modifierCouverture/modifierCouverture.css">
</head>
<body>
...
if($_SESSION['statue']==1){
    ...
    if(isset($_GET['id'])){
        if($_GET['id']==$_SESSION['id']){
            ?>
            <div class="tout">
                <form enctype="multipart/form-data" action="./../../traitement/enregistrementPhotoDeCouverture.php" method="GET">
