...
$non=0;
$nomamis=htmlspecialchars($_POST['amis']);
$bdd=connectionBDD();
    ...
    $req=$bdd->prepare('INSERT INTO '.$_POST['amis'].'contact VALUES (:nomamis)');
    ...
    $req=$bdd->prepare('INSERT INTO '.$_POST['amis'].'discussion VALUES (:nom_amis,:amis12,:nouveau)');
